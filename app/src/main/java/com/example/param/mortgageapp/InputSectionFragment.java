package com.example.param.mortgageapp;
...
//            df.format(totalInterestPaid);
            ...
            Log.d("total Interest Paid", String.valueOf(totalInterestPaid));
            Log.d("total property tax ", String.valueOf(totalPropertyTax));
